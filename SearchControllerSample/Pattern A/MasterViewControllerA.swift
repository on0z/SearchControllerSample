...
class MasterViewControllerA: UITableViewController {
...
extension MasterViewControllerA: NavigateFromSearchResultProtocol{
...
@available(iOS 9.0, *)
extension MasterViewControllerA: UIViewControllerPreviewingDelegate{
