...
class MasterViewControllerB: UITableViewController {
...
extension MasterViewControllerB: NavigateFromSearchResultProtocol{
...
@available(iOS 9.0, *)
extension MasterViewControllerB: UIViewControllerPreviewingDelegate{
